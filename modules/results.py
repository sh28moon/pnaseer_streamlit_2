...
def show():
    ...
    with tab_summary:
        ...
        if ('formulation_data' in analysis_profile_data and 
            ...
            with col_atps:
                ...
                random.seed(hash(f"{current_job_name}_{selected_analysis_profile}_{selected_analysis_formulation}_atps") % 2147483647)
            ...
            with col_performance:
                ...
                random.seed(hash(f"{current_job_name}_{selected_analysis_profile}_{selected_analysis_formulation}_{selected_formulation}_drug_release") % 2147483647)
            ...
            with col_radar:
                ...
                random.seed(hash(f"{current_job_name}_{selected_analysis_profile}_{selected_analysis_formulation}_{selected_formulation}_radar") % 2147483647)
    ...
    with tab_evaluation:
        ...
        if 'analysis_profile_select' in st.session_state and st.session_state.analysis_profile_select:
            ...
            eval_seed = hash(f"{current_job_name}_{selected_eval_profile}_{selected_eval_formulation}_evaluation") % 2147483647
